...
const newGame = require("./commands/slash/newGame");
const look = require("./commands/slash/look");
const attack = require("./commands/slash/attack");
const block = require("./commands/slash/block");
const move = require("./commands/slash/move");
...
module.exports = {
    ...
    "new game": {
        fn: newGame,
        alias: ["new", "startover", "startnew"],
        args: [],
        help: {
            short: "New game",
            long: "Start a new game, initializes character with Server or Guild"
        }
    },
    "attack": {
        fn: attack,
        ...
        help: {
            short: "Attacks",
            long: "Attack with the swift stroke of your fingers at the keys"
        }
    },
    "block": {
        fn: block,
        ...
        help: {
            short: "Blocks",
            long: "Blocks with the swift stroke of your fingers at the keys"
        }
    },
    "move": {
        fn: move,
        ...
        help: {
            short: "Moves your character",
            long: "Moves your character with the swift stroke of your fingers at the keys"
        }
    },
    "look": {
        fn: look,
        alias: ["look", "look around", "check surroundings"],
        args: [],
        help: {
            short: "Checks your surroundings",
            long: "Good for resuming play from taking a break"
        }
    },
