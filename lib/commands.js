...
const commit = require("./commands/lisa/commit");
const rate = require("./commands/lisa/rate");
const ship = require("./commands/lisa/ship");
const interesting = require("./commands/lisa/interesting");
const roasted = require("./commands/lisa/roasted");
const clap = require("./commands/lisa/clap");
const square = require("./commands/lisa/square");
